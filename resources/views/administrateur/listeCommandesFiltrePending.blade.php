    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <nav class="text-white bg-gray-800 sidebar">
                ...
                <!-- Nav Item - Profil -->
                <li class="nav-item ">
                    <a class="bg-yellow-500 nav-link" href="{{ route('pendingAdmin') }}">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="flex items-center justify-between my-6">
                        ...
                        <a href="{{ route('listeCommandesPendingAdmin.print') }}?date_debut={{ request('date_debut') }}&date_fin={{ request('date_fin') }}"
                            target="_blank"
