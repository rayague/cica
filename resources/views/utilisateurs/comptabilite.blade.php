        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="mb-4 bg-white shadow navbar navbar-expand navbar-light topbar static-top">
                    ...
                    <a href="{{ route('listeCommandes.print', ['start_date' => now()->toDateString(), 'end_date' => now()->toDateString()]) }}" target="_blank" class="ml-4 inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-semibold text-sm">
