        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="mb-4 bg-white shadow navbar navbar-expand navbar-light topbar static-top">
                    ...
                    <a href="{{ route('rappels.imprimer') }}" target="_blank" class="ml-4 inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-semibold text-sm">
                            ...
                            @foreach ($commandes as $commande)
                                <div class="p-6 transition duration-200 bg-white rounded-lg shadow-md hover:shadow-xl">
                                    ...
                                    <div class="text-center space-y-2">
                                        ...
                                        <br>
                                        <a href="https://wa.me/229{{ ltrim(preg_replace('/[^0-9]/', '', $commande->numero_whatsapp), '0') }}?text={{ urlencode('Bonjour ' . $commande->client . ', merci pour votre confiance ! Votre commande #' . $commande->numero . ' a été retirée avec succès. À bientôt chez CICA NOBLESSE PRESSING !') }}"
                                            target="_blank"
