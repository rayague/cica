...
<head>
    ...
    <style>
        ...
        body { font-family: 'Arial', 'Helvetica', sans-serif; font-size: 8px; margin: 0; padding: 0; color: #2d3748; }
        .sheet-table { width: 100%; border-collapse: collapse; table-layout: fixed; page-break-inside: avoid; }
        .sheet-table td {
            width: 80%; /* Réduit la largeur de la colonne */
            max-width: 210mm;
            vertical-align: top;
            padding: 2mm;
        ...
        .header { display: flex; justify-content: space-between; border-bottom: 1px solid #0084ff; margin-bottom: 2mm; padding-bottom: 1mm; page-break-inside: avoid; }
        .brand-section { width: 60%; display: flex; align-items: flex-start; gap: 8px; }
        .label { font-weight: bold; }
        .logo-container { flex-shrink: 0; width: 35px; height: 35px; display: flex; align-items: center; justify-content: center; background: #f7fafc; border-radius: 4px; border: 1px solid #e2e8f0; }
        .logo { max-width: 100%; max-height: 100%; object-fit: contain; border-radius: 2px; }
        .brand-text { flex: 1; min-width: 0; }
        .brand-section h1 { font-size: 10px; margin: 0 0 1mm 0; color: #0084ff; }
        .brand-section p { margin: 0; font-size: 8px; }
        .invoice-info { text-align: right; font-size: 8px; }
        .invoice-info h2 { margin: 0 0 1mm 0; font-size: 14px; color: #000; letter-spacing: 1px; }
        .invoice-info p strong { font-size: 13px; }
        .invoice-info p { font-size: 13px; }
        .details-grid { display: flex; justify-content: space-between; background: #f0f7fd; border: 1px solid #53b2ff; padding: 6px; margin-bottom: 10px; width: 97%; box-sizing: border-box; border-radius: 3px; font-family: 'Arial', 'Helvetica', sans-serif; }
        .detail-left, .detail-right { flex: 0 0 48%; }
        .detail-left { border-right: 1px solid #0084ff; padding-right: 10px; }
        .detail-right { padding-left: 10px; padding-right: 10px; text-align: right; }
        .detail-title { font-weight: 600; font-size: 9px; color: #0084ff; margin-bottom: 2px; text-transform: uppercase; letter-spacing: 0.3px; padding: 1px 0px; border-radius: 2px; display: inline-block; }
        .detail-info { font-size: 8px; font-weight: bold; line-height: 1.1; margin-bottom: 1px; padding: 0; }
        .detail-info:last-child { margin-bottom: 0; }
        .date-value { font-weight: 500; }
        .items-table { width: 100%; font-size: 8px; border-collapse: collapse; margin: 1mm 0; page-break-inside: avoid; }
        .items-table th { background-color: #0084ff; color: white; padding: 1mm; text-align: left; font-size: 8px; }
        .items-table td { border-bottom: 1px solid #e2e8f0; padding: 1mm; font-size: 8px; }
        .total-section { margin-top: 2mm; font-size: 10px; page-break-inside: avoid; }
        .total-line { display: flex; justify-content: space-between; margin: 0.5mm 0; }
        .badge { padding: 0.5mm 1mm; background-color: #edf2f7; border-radius: 2px; font-weight: bold; font-size: 8px; }
        .historique-header { margin-top: 2mm; font-size: 9px; font-weight: bold; }
        .notes-table { width: 100%; font-size: 7px; border-collapse: collapse; margin-top: 1mm; page-break-inside: avoid; }
        .notes-table th { background-color: #0084ff; color: white; padding: 1mm; text-align: left; font-size: 7px; }
        .notes-table td { border-bottom: 1px solid #e2e8f0; padding: 1mm; font-size: 7px; }
        .conditions { margin-top: 2mm; font-size: 6px; page-break-inside: avoid; }
        .conditions ul { padding-left: 10px; margin: 1mm 0; }
        .conditions li { margin-bottom: 0.5mm; }
        @media print { body { font-size: 12px; } .invoice-column { border: none; padding: 0; height: auto; } .sheet-table td { padding: 0; } .sheet-table tr { page-break-after: always; } .sheet-table tr:last-child { page-break-after: avoid; } .logo-container { background: transparent; border: none; } } .total-line.solde .badge { font-size: 12px !important; color: #dc2626; background: #fff0f0; border: 1px solid #dc2626; }
    </style>
</head>
<body>
