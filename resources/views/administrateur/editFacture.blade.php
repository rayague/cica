...
<head>
    ...
    <title>Cica - Administration - Modifier Facture</title>
        ...
        <div id="content-wrapper" class="flex-1">
            ...
            <div id="content">
                ...
                <nav class="mb-4 bg-white shadow navbar navbar-expand navbar-light topbar static-top">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">Administration - Modifier Facture</h3>
                        ...
                        <form action="{{ route('admin.factures.update', $commande->id) }}" method="POST">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                <div>
                                    ...
                                    <input type="text" id="client" name="client" value="{{ old('client', $commande->client) }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>

                                <div>
                                    <label for="numero_whatsapp" class="block text-sm font-medium text-gray-700 mb-2">Numéro WhatsApp</label>
                                    <input type="text" id="numero_whatsapp" name="numero_whatsapp" value="{{ old('numero_whatsapp', $commande->numero_whatsapp) }}"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                                ...
                                <div>
                                    ...
                                    <select id="statut" name="statut"
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                        <option value="Non retirée" {{ old('statut', $commande->statut) == 'Non retirée' ? 'selected' : '' }}>Non retirée</option>
                                        <option value="Retiré" {{ old('statut', $commande->statut) == 'Retiré' ? 'selected' : '' }}>Retiré</option>
                                        <option value="Partiellement payé" {{ old('statut', $commande->statut) == 'Partiellement payé' ? 'selected' : '' }}>Partiellement payé</option>
                                        <option value="Payé - Non retiré" {{ old('statut', $commande->statut) == 'Payé - Non retiré' ? 'selected' : '' }}>Payé - Non retiré</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Avance client (non modifiable)</label>
