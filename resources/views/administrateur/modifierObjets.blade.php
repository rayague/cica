            ...
            <div id="content">
                ...
                <div class="px-4 py-6 container-fluid">
                    ...
                    <div class="p-8 bg-white rounded-lg shadow-lg">
                        <h2 class="mb-6 text-2xl font-bold text-gray-800">Modifier l'objet</h2>
                        ...
                        <form action="{{ route('objets.update', $objet->id) }}" method="POST">
                            ...
                            <div class="mb-4">
                                <label for="nom" class="block text-lg font-bold text-gray-700">Nom de
                                    l'objet</label>
                            ...
                            <div class="mb-4">
                                <label for="prix_unitaire" class="block text-lg font-bold text-gray-700">Prix
                                    unitaire</label>
                                <input type="number" name="prix_unitaire" id="prix_unitaire"
                                    value="{{ old('prix_unitaire', $objet->prix_unitaire) }}"
                                    class="w-full px-4 py-2 border border-gray-300 rounded-lg" required>
                            </div>
